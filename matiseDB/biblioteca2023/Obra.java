...
public class Obra extends com.matisse.reflect.MtObject {
    ...
    private static int CID = com.matisse.MtDatabase.allocCID(new com.matisse.reflect.MtClass.Loader("biblioteca2023.Obra"));
     ...
     */
    public final biblioteca2023.Autor[] getEscrita_por() {
        return (biblioteca2023.Autor[])getSuccessors(getEscrita_porRelationship(getMtDatabase()), biblioteca2023.Autor.class);
    }
    ...
    public final <E extends com.matisse.reflect.MtObject> com.matisse.MtObjectIterator<E> escrita_porIterator() {
        return this.<E>successorIterator(getEscrita_porRelationship(getMtDatabase()), biblioteca2023.Autor.class);
    }
     ...
     * @see #removeEscrita_por
     */
    public final void setEscrita_por(biblioteca2023.Autor[] succs) {
     ...
     * @see #removeEscrita_por
     */
    public final void prependEscrita_por(biblioteca2023.Autor succ) {
     ...
     * @see #escrita_porIterator
     */
    public final void appendEscrita_por(biblioteca2023.Autor succ) {
     ...
     * @see #escrita_porIterator
     */
    public final void appendEscrita_por(biblioteca2023.Autor[] succs) {
     ...
     * @see #escrita_porIterator
     */
    public void removeEscrita_por(biblioteca2023.Autor[] succs) {
     ...
     * @see #escrita_porIterator
     */
    public void removeEscrita_por(biblioteca2023.Autor succ) {
